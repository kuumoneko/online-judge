...
function test(users, page, modee, search = "") {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const headers = ["rank", { username: "username", group: "group" }, "problems_count", "points"];
        ...
        lmao.render(React.createElement(StrictMode, null,
            React.createElement("tbody", { style: { display: "table-row-group", verticalAlign: "middle", borderColor: "inherit" } },
                React.createElement("tr", { style: { borderTop: "1px solid #dddddd" } },
                    ...
                    React.createElement("th", { id: "users", style: { width: "10%" } },
                        React.createElement("button", { name: "pnt" }, "Points"))),
...
export function Home_Users() {
    let rank = "auto", prlcnt = "auto", pnt = "up";
    let curr_page = 1;
