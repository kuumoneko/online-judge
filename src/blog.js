...
import { color, color_themes, getdata, sort_blogs } from "./ulti.js";
...
export function Blog({ url }) {
    ...
    useEffect(() => {
        function blogs() {
            return __awaiter(this, void 0, void 0, function* () {
                const blogs = yield getdata("get", "blogs", url[1]);
    ...
    return (React.createElement("div", null,
        (url[3] == undefined && url[1] == user.username) && (React.createElement(React.Fragment, null,
            React.createElement("br", null),
            React.createElement("div", { style: {
                    height: "100px",
                    width: "1500px",
