...
import { getdata, color_themes, get_rank_color } from "types";
    ...
    useEffect(() => {
        function blogs() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const users = yield getdata("sort", "users", { mode: "points", search: "", reverse: true, page: 1, lineperpage: 10 });
                // console.log(users)
