...
function Profile({ users, user }) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", null,
            React.createElement("div", { style: { float: "left", height: "400px", width: "250px", border: "1px 1px 1px 1px" } },
                React.createElement("div", null,
                    ...
                    React.createElement("a", { style: { display: "block", borderBottom: "1px solid #d2d2d2", width: "250px" } }),
                    React.createElement("h4", { style: { borderBottom: "0px" } },
            ...
            React.createElement("div", { style: { float: "right", height: "400px", width: "1600px" } },
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (url[2]) {
                    ...
                    if (url[2] == "edit_profile") {
                        renderr = (React.createElement(Editprofile, { user: users[users.findIndex((userr) => userr.username == url[1])] }));
                    }
                    else if (url[2] == "blogs") {
                        renderr = (React.createElement(Blog, { url: url }));
                    }
                    root.render(renderr);
                }
                else {
                    root.render(React.createElement(Profile, { users: users, user: JSON.parse(localStorage.getItem("user")) }));
                }
            });
        }
        lmao();
