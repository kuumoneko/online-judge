...
import { User, Blog } from "type";
import { getdata } from "ulti";
import { color_themes, get_rank_color } from "color";
    ...
    useEffect(() => {
        async function blogs() {
            ...
            sethtml(
                <div>
                    {
                        (blogs.data.data as Blog[]).map((item, _index) => {
                            // console.log(item)
            ...
            settop(
                <tbody>
                    ...
                    {
                        (users.data.data as User[]).map((user: User, index: number) => {
                            return (
                                <tr>
