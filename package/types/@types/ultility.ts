...
export function generateRandomString(length: number, Options: { isUpper?: boolean, isSpecial?: boolean, isNumber?: boolean } = { isUpper: false, isSpecial: false, isNumber: false }) {
