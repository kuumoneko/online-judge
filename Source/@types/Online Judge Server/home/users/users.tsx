...
import { color, get_rank_color, getdata, User, Languages, Theme_mode, User_role } from "online-judge-types";
...
export function Home_Users() {
    ...
    useEffect(() => {
        ...
        async function lmao() {
            const res = await getdata("sort", "users", { mode: mode, search: { mode: "all", find: search }, reverse: reverse, page: curr_page, lineperpage: 100 });
