...
export function generateRandomString(length: number, Options: { isUpper?: boolean, isSpecial?: boolean, isNumber?: boolean } = { isUpper: false, isSpecial: false, isNumber: false }): string {
...
export function cookie(document: Document): { [key: string]: string } {
...
export const all_language: string[] = ["C++03", "C++11", "C++14 (C++ Themis)", "C++17", "C++20", "Python 3", "java", "javascript"];
...
export function editor_preview(data: string): any {
