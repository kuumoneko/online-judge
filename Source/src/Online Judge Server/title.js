...
export function Title({ url, themes }) {
    ...
    useEffect(() => {
        function lmao() {
            return __awaiter(this, void 0, void 0, function* () {
                yield getdata("get", "users", username).then((user) => {
    ...
    useEffect(() => {
        function lmaoo() {
            return __awaiter(this, void 0, void 0, function* () {
                const session = yield getdata("auth", "users", Cookies.get("sessionId"));
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement("div", { className: 'tabs', style: {
            ...
            (temp == "users" || temp == "groups") ? (React.createElement(Userss, { mode: temp, themes: themes })) : (temp == "user") ? (React.createElement(Userr, { mode: url, themes: themes, user: username })) : (React.createElement(React.Fragment, null)))));
}
