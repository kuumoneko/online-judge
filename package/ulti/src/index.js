    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (method == "get") {
                ...
                res = yield axios.post(`http://localhost:3001/forgot_password/${data.username}/${data.mode}/${data.data}`, {}, {});
            }
            else if (method == "change_password") {
                res = yield axios.post("http://localhost:3001/auth/change_password", { data }, {});
            }
            else if (method == "forgot_password") {
                res = yield axios.post("http://localhost:3001/auth/forgot_password", { data }, {});
            }
        }
        catch (e) {
